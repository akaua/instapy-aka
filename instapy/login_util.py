...
##ALTERADO POR AKAUA -  Linhas: 150 a 153 comentadas - 183 a 186 comentado e modificado
import time
import pickle
...
def login_user(browser,
    ...
    login_button = browser.find_element_by_xpath("//form/div[3]/button[text()='Log in']")
